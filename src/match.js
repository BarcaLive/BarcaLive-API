...
export async function handleMatches(isoCode, env, ctx) {
  ...
  // Use Cache: Live/Upcoming (limit=5) -> Short Cache (120s TTL)
  // Past (limit=15) -> Medium Cache (300s TTL)

  // OPTIMIZATION: Use rounded timestamps to ensure stable cache keys and avoid redundant API requests
